     ...
     <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
        ...
        <form onSubmit={onSubmitHandler}>
            <div className='mb-3 min-w-72'>
                ...
                <input type="email" placeholder='name@gmail.com' required className='rounded-md w-full px-3 py-2 border border-gray-300 outline-none' value={email} onChange={(e) => setEmail(e.target.value)}/>
            </div>
